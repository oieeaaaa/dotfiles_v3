...
vim.o.colorcolumn = "80" -- will display the max character length guide
...
vim.o.relativenumber = true -- show relative number on the left
...
vim.o.undodir = HOME .. '/.vim/undodir//' -- undo files
